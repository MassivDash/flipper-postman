// Description: UART text input module implementation.
// Author: cool4uma
// Source: https://github.com/cool4uma/UART_Terminal/blob/main/uart_text_input.c
// Big props for this improved version of text input module
...
typedef bool (*UART_TextInputValidatorCallback)(const char *text,
                                                FuriString *error,
                                                void *context);
...
void *
uart_text_input_get_validator_callback_context(UART_TextInput *uart_text_input);
